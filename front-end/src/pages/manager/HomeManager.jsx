// pages/HomeManager.jsx
import styles from "./HomeManager.module.css"; // Import styles cho HomeManager
  ...
  return (
    <div className={styles["admin-functions"]}>
      <div className={styles["function-box"]}>
        ...
        <a href="/manager/users">Xem chi tiết</a>
      </div>
      <div className={styles["function-box"]}>
        <i className="fa-solid fa-newspaper"></i>
        <h3>Quản lý bài viết</h3>
        <p>Đăng, chỉnh sửa và xóa các bài viết thông báo.</p>
        <a href="/manager/posts">Xem chi tiết</a>
      </div>
      <div className={styles["function-box"]}>
